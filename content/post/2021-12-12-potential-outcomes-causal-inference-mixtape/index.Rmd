...
[^5]: I'm saying "usually enough" and not "enough" because despite being randomized, trials still can show have biased results due to other problems, such as [spillovers](https://en.wikipedia.org/wiki/Spillover_(experiment)). This can be a topic for another blog post in the future.