---
title: 'Matching in R (I): Subclassification, Common Support and the Curse of Dimensionality'
...
***UPDATE:** check out Part 2 [here](/post/matching-in-r-2-differences-regression/) and Part 3 [here](/post/matching-in-r-3-propensity-score-iptw/).*
