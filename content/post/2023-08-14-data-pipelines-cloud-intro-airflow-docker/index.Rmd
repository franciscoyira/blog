---
title: "Data Pipelines in the Cloud (I): A Beginner's Introduction  to Airflow"
...
-   **WSL 2.0 enabled and configured**. If you don't have this already, you can just open PowerShell or Windows Command Prompt in administrator mode (by right-clicking and selecting "Run as administrator"), then enter the `wsl --install command` and then restart your machine.
