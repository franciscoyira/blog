...
yearvalues=list(np.arange(1970, 2021, 5))

fiveyearcats=pd.Categorical.from_codes(yearvalues, fiveyearlabels)
fiveyearcats
```

```{python}
df_tracks.FiveYearPeriod.astype('category')
```
