...
-   How do we know if we have conditional independence? Technically, it's an untestable assumption, but we can assess how reasonable or far fetched it's to believe in it by **drawing a [causal diagram](https://www.franciscoyira.com/post/2021-07-11-diagramas-causalidad-cap-3-causal-inference-mixtape/)**[ **(DAG)**](https://www.franciscoyira.com/post/2021-07-11-diagramas-causalidad-cap-3-causal-inference-mixtape/), which is a neat representation of all our current knowledge about the data generating process. By looking at our DAG, we can tell if it makes sense to assume conditional independence in our data.
