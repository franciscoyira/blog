...
Aquí **D** representa la variable de interés, **Y** es una variable de resultados, y **X** representa una tercera variable, que probablemente no es el foco del análisis. Quien se enfrente a DAG probablemente busca conocer el efecto causal de **D sobre Y**.
