...
But most importantly, I'm sharing my solutions through a special, advent-of-code-themed website created with [Quarto](https://quarto.org/): [**adventofcode.franciscoyira.com**](https://adventofcode.franciscoyira.com)**.**

![](images/minisite-aoc.png)

I've already posted there some of the solutions I've completed so far, and I'll continue to do so until I've attempted all 25 puzzles of 2023 (although I'll probably finish in January 2024). Here is an example with [day 1](https://adventofcode.franciscoyira.com/2023/day/1/).
