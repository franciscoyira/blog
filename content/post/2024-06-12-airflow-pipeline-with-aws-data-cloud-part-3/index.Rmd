...
-   You have the **AWS Command Line Interface tool installed and configured with an AWS account**. If you need help with that, check [the second part of this series](post/aws-command-line-data-pipelines-cloud-part-2/). **There you can also find detailed explanations of all the AWS CLI commands and AWS services used in this third part**. I’ll skip explaining these again in this new post to focus on the Airflow DAG instead.
