...
![*Source: [https://www.jclinepi.com/article/S0895-4356(05)00224-6/fulltext](https://www.jclinepi.com/article/S0895-4356(05)00224-6/fulltext)*](images/density_plot_no_common_support.png){width="500"}
...
Great! We now have the propensity scores! But how do we use them? A common sense answer would be to do matching based on them and, in fact, this was what a lot papers did for a lot of time. However...

OK, but how do we use this propensity scores? A common sense idea based on what we already know is to do Matching on the Propensity Scores, and in fact this is what a lot of papers do. But this approach has become
